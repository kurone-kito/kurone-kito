...
The numeric `<!-- kurone-kito-autopilot-suitability: N -->`
...
`<!-- kurone-kito-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- kurone-kito-triage-verdict: <outcome> -->
```
...
`kurone-kito-triage-verdict` marker. Apply the same
