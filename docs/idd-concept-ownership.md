...
| Branch | Worker session, B1 | Worker session (pushes at D2/E12; merge-from-`master` at E-phase sync/E11) | B1 self-check; cwd-vs-claim check in the claim revalidation gate |
