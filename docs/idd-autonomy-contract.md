...
| Delete remote branch (when GitHub auto-delete is disabled)            | Reversible                | Content is preserved via the merge commit on `master`; only runs after a successful merge                                                     | F4 (`idd-merge.instructions.md`) |
| Update local `master`                                                | Reversible                | Trivial fast-forward re-fetch                                                                                                               | F4 (`idd-merge.instructions.md`) |
